...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Arc2, lv_color_hex(0xFFFF00), LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label5, "Kakutai");
    ...
    lv_label_set_text(ui_Label6, "HID KYBD");
    ...
    lv_label_set_text(ui_Label7, "VOL");
    ...
    ui_Arc3 = lv_label_create(ui_Screen1);
    lv_obj_set_width(ui_Arc3, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Arc3, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Arc3, 43);
    lv_obj_set_y(ui_Arc3, -107);

    lv_obj_set_align(ui_Arc3, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Arc3, "[ COMMAND ]");
    lv_obj_set_style_text_color(ui_Arc3, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Arc3, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_Arc3, &lv_font_montserrat_10, LV_PART_MAIN | LV_STATE_DEFAULT);
